...
length_map={'lcsts':'30','csl':'50','adgen':'128','hk01':'200'}


args=[
    '--model_name_or_path',arg_dict['model_path'],
    '--do_train','--do_eval','--do_predict',
    '--train_file',os.path.join(arg_dict['data_dir'],'SUMMARY.'+dataset_name,'train.csv'),
    '--validation_file',os.path.join(arg_dict['data_dir'],'SUMMARY.'+dataset_name,'dev.csv'),
    '--test_file',os.path.join(arg_dict['data_dir'],'SUMMARY.'+dataset_name,'test.csv'),
    '--output_dir',outdir,
